...
#define rw PC4 //read/write signal
#define rs PC5 //resister select signal
...
void LCD_print(unsigned char *str) //take address vaue of the string in pionter *str
{
	int i=0;
